...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				<tr>
				<td><img src="<?php echo $item["image"]; ?>" class="cart-item-image" style="height:80px;" /><?php echo $item["name"]; ?></td>
...
<a href="welcome.php" ><input type="button" value="Continue Shopping" class="btn btn-default btn-success"/></a>
</form>
</div>	
<!--the </button> end-->
